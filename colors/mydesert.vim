...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    "DiffText
    "ErrorMsg
    call <SID>X("VertSplit", "bfbfbf", "5f5f5f", "reverse")
    ...
    call <SID>X("StatusLine", "bfbfbf", "000000", "reverse")
    call <SID>X("StatusLineNC", "5f5f5f", "bfbfbf", "reverse")
    ...
    call <SID>X("Identifier", "bdb76b", "", "none")
